...
export default function DocumentsPage() {
  ...
  const canManageDocuments = ["ADMINISTRATEUR", "AGENT_IMPORT_EXPORT"].includes(user?.role);
    ...
    <>
      ...
      <div className="row g-4">
        <div className="col-12 col-xl-5"><section className="card h-100"><div className="card-body">
          ...
          {canManageDocuments && <><hr className="my-4" /><h2>Ajouter un document</h2>
